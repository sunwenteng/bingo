...
gulp.task('proto2json', shell.task('./node_modules/protobufjs/bin/pbjs -t json-module -w commonjs -o ./src/game_app/proto/cmd.js ' + protoFiles.join(' ') + ' && ' +
    './node_modules/protobufjs/bin/pbjs -t static-module ' + protoFiles.join(' ') + ' | ./node_modules/protobufjs/bin/pbts --no-comments -o ./src/game_app/proto/cmd.d.ts -'));
// 生成的文件较大
gulp.task('proto2js', shell.task('./node_modules/protobufjs/bin/pbjs -t static-module -w commonjs -o ./src/game_app/proto/cmd.js ' + protoFiles.join(' ') + ' && ' +
    './node_modules/protobufjs/bin/pbts --no-comments -o ./src/game_app/proto/cmd.d.ts ./src/game_app/proto/cmd.js'));

gulp.task('proto2client', shell.task('./node_modules/protobufjs/bin/pbjs -t static-module -w amd -o ./src/game_app/proto/cmd.js ' + protoFiles.join(' ') + ' && ' +
    './node_modules/protobufjs/bin/pbts --no-comments -o ./src/game_app/proto/cmd.d.ts ./src/game_app/proto/cmd.js'));