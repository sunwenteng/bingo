...
export namespace S2C {
    ...
    interface IMessage {
        ...
        SC_ROLE_UPDATE?: (S2C.ISC_ROLE_UPDATE|null);
    ...
    class Message implements IMessage {
        ...
        public SC_ROLE_UPDATE?: (S2C.ISC_ROLE_UPDATE|null);
        ...
        public kind?: ("Error"|"SC_TEST_ECHO"|"SC_ROLE_ONLINE"|"SC_ROLE_HEART_BEAT"|"SC_ROLE_UPDATE"|"LOGIN_SC_LOGIN"|"LOGIN_SC_CHOOSE_SERVER"|"LOGIN_SC_GET_SERVER_LIST"|"LOGIN_SC_GET_INFO");
    ...
    class SC_ROLE_UPDATE implements ISC_ROLE_UPDATE {
        constructor(properties?: S2C.ISC_ROLE_UPDATE);
        public nickname: string;
        public level: number;
        ...
        public diamond: number;
        public gold: (number|Long);
        public static create(properties?: S2C.ISC_ROLE_UPDATE): S2C.SC_ROLE_UPDATE;
        public static encode(message: S2C.ISC_ROLE_UPDATE, writer?: $protobuf.Writer): $protobuf.Writer;
        public static encodeDelimited(message: S2C.ISC_ROLE_UPDATE, writer?: $protobuf.Writer): $protobuf.Writer;
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): S2C.SC_ROLE_UPDATE;
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): S2C.SC_ROLE_UPDATE;
        public static verify(message: { [k: string]: any }): (string|null);
        public static fromObject(object: { [k: string]: any }): S2C.SC_ROLE_UPDATE;
        public static toObject(message: S2C.SC_ROLE_UPDATE, options?: $protobuf.IConversionOptions): { [k: string]: any };
        public toJSON(): { [k: string]: any };
    }
